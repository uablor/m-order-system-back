...
describe('OrderQueryService', () => {
  ...
  const mockOrder = {
    ...
    totalShippingCost: '500.00',
    totalCostBeforeDiscount: '5000.00',
    totalDiscount: '0.00',
    totalFinalCost: '5000.00',
    totalSellingAmount: '8000.00',
    totalProfit: '3000.00',
    depositAmount: '0.00',
    paidAmount: '0.00',
    ...
    createdAt: new Date(),
    updatedAt: new Date(),
    exchangeRateBuyValue: '650.00',
    exchangeRateSellValue: '670.00',
  };
