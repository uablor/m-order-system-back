...
export class UpdateSchema1772337364719 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`merchants\` DROP COLUMN \`shop_logo_url_id\``);
        await queryRunner.query(`ALTER TABLE \`merchants\` ADD \`shop_logo_url_id\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`merchant_id\` \`merchant_id\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`order_items\` DROP FOREIGN KEY \`FK_1dd6047aa9dea61f230d978df96\``);
        await queryRunner.query(`ALTER TABLE \`order_items\` DROP FOREIGN KEY \`FK_62ca39fa0ca229827ef3ab378a3\``);
        ...
        await queryRunner.query(`ALTER TABLE \`order_items\` CHANGE \`exchange_rate_buy\` \`exchange_rate_buy\` decimal(18,6) NULL`);
        await queryRunner.query(`ALTER TABLE \`order_items\` CHANGE \`exchange_rate_sell\` \`exchange_rate_sell\` decimal(18,6) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`order_items\` CHANGE \`exchange_rate_buy_id\` \`exchange_rate_buy_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`order_items\` CHANGE \`exchange_rate_sell_id\` \`exchange_rate_sell_id\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` DROP FOREIGN KEY \`FK_1f5c40873f36bceb4949d678362\``);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP FOREIGN KEY \`FK_08d08fb720b52808b2e6931cda0\``);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`exchange_rate_buy\` \`exchange_rate_buy\` decimal(18,6) NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`exchange_rate_sell\` \`exchange_rate_sell\` decimal(18,6) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`exchange_rate_buy_id\` \`exchange_rate_buy_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`exchange_rate_sell_id\` \`exchange_rate_sell_id\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`payment_date\` \`payment_date\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`payments\` DROP COLUMN \`payment_proof_image_id\``);
        await queryRunner.query(`ALTER TABLE \`payments\` ADD \`payment_proof_image_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`customer_message\` \`customer_message\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`verified_by\` \`verified_by\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`verified_at\` \`verified_at\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`rejected_by\` \`rejected_by\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`images\` ADD CONSTRAINT \`FK_c3e195b58e1e2567f442eff3551\` FOREIGN KEY (\`merchant_id\`) REFERENCES \`merchants\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`images\` ADD CONSTRAINT \`FK_6d664f5fd368da18598eb947cc4\` FOREIGN KEY (\`uploaded_by\`) REFERENCES \`users\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`merchants\` ADD CONSTRAINT \`FK_1264ed72c71e1607b1240f6a49c\` FOREIGN KEY (\`shop_logo_url_id\`) REFERENCES \`images\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`order_items\` ADD CONSTRAINT \`FK_1dd6047aa9dea61f230d978df96\` FOREIGN KEY (\`exchange_rate_buy_id\`) REFERENCES \`exchange_rates\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`order_items\` ADD CONSTRAINT \`FK_62ca39fa0ca229827ef3ab378a3\` FOREIGN KEY (\`exchange_rate_sell_id\`) REFERENCES \`exchange_rates\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` ADD CONSTRAINT \`FK_1f5c40873f36bceb4949d678362\` FOREIGN KEY (\`exchange_rate_buy_id\`) REFERENCES \`exchange_rates\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD CONSTRAINT \`FK_08d08fb720b52808b2e6931cda0\` FOREIGN KEY (\`exchange_rate_sell_id\`) REFERENCES \`exchange_rates\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`payments\` ADD CONSTRAINT \`FK_4924b2f8f19d380fd7b7a8709a2\` FOREIGN KEY (\`payment_proof_image_id\`) REFERENCES \`images\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`payments\` DROP FOREIGN KEY \`FK_f1cf0b736bfb684c15410e1e44b\``);
        await queryRunner.query(`ALTER TABLE \`payments\` DROP FOREIGN KEY \`FK_fc2beb4403c1d6267b003e0889c\``);
        await queryRunner.query(`ALTER TABLE \`payments\` DROP FOREIGN KEY \`FK_4924b2f8f19d380fd7b7a8709a2\``);
        await queryRunner.query(`ALTER TABLE \`customer_orders\` DROP FOREIGN KEY \`FK_d7fd44c68cff957a9168272c745\``);
        await queryRunner.query(`ALTER TABLE \`customer_orders\` DROP FOREIGN KEY \`FK_4665b4d203357f4cd8d74e54b1c\``);
        await queryRunner.query(`ALTER TABLE \`customers\` DROP FOREIGN KEY \`FK_c73a42116fe791faa952b71e9dd\``);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP FOREIGN KEY \`FK_08d08fb720b52808b2e6931cda0\``);
        ...
        await queryRunner.query(`ALTER TABLE \`customer_order_items\` DROP FOREIGN KEY \`FK_b9e59e7b59ba5c0c5ab21c851f8\``);
        await queryRunner.query(`ALTER TABLE \`users\` DROP FOREIGN KEY \`FK_fe996f039efa99e46d75761aad0\``);
        await queryRunner.query(`ALTER TABLE \`merchants\` DROP FOREIGN KEY \`FK_1264ed72c71e1607b1240f6a49c\``);
        await queryRunner.query(`ALTER TABLE \`images\` DROP FOREIGN KEY \`FK_6d664f5fd368da18598eb947cc4\``);
        await queryRunner.query(`ALTER TABLE \`images\` DROP FOREIGN KEY \`FK_c3e195b58e1e2567f442eff3551\``);
        ...
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`rejected_by\` \`rejected_by\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`verified_at\` \`verified_at\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`verified_by\` \`verified_by\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`customer_message\` \`customer_message\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`payments\` DROP COLUMN \`payment_proof_image_id\``);
        await queryRunner.query(`ALTER TABLE \`payments\` ADD \`payment_proof_image_id\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`payment_date\` \`payment_date\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`payments\` ADD CONSTRAINT \`FK_f1cf0b736bfb684c15410e1e44b\` FOREIGN KEY (\`rejected_by\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`payments\` ADD CONSTRAINT \`FK_fc2beb4403c1d6267b003e0889c\` FOREIGN KEY (\`verified_by\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`customers\` ADD CONSTRAINT \`FK_c73a42116fe791faa952b71e9dd\` FOREIGN KEY (\`merchant_id\`) REFERENCES \`merchants\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`exchange_rate_sell_id\` \`exchange_rate_sell_id\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`exchange_rate_buy_id\` \`exchange_rate_buy_id\` int NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`exchange_rate_sell\` \`exchange_rate_sell\` decimal(18,6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`exchange_rate_buy\` \`exchange_rate_buy\` decimal(18,6) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` ADD CONSTRAINT \`FK_574a2f0932043d4e4baf188ee05\` FOREIGN KEY (\`created_by\`) REFERENCES \`users\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD CONSTRAINT \`FK_2474866c8f8e9196ff227a7cbbd\` FOREIGN KEY (\`merchant_id\`) REFERENCES \`merchants\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`order_items\` CHANGE \`exchange_rate_sell_id\` \`exchange_rate_sell_id\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`order_items\` CHANGE \`exchange_rate_buy_id\` \`exchange_rate_buy_id\` int NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`order_items\` CHANGE \`exchange_rate_sell\` \`exchange_rate_sell\` decimal(18,6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`order_items\` CHANGE \`exchange_rate_buy\` \`exchange_rate_buy\` decimal(18,6) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`merchant_id\` \`merchant_id\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD CONSTRAINT \`FK_fe996f039efa99e46d75761aad0\` FOREIGN KEY (\`merchant_id\`) REFERENCES \`merchants\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`merchants\` DROP COLUMN \`shop_logo_url_id\``);
        await queryRunner.query(`ALTER TABLE \`merchants\` ADD \`shop_logo_url_id\` text NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_932c7c986f598d25111c5bc692\` ON \`images\``);
        await queryRunner.query(`DROP TABLE \`images\``);
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`payment_proof_image_id\` \`payment_proof_url\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`merchants\` CHANGE \`shop_logo_url_id\` \`shop_logo_url\` text NULL DEFAULT 'NULL'`);
    }
