  ...
  private toResponse(entity: import('../entities/order.orm-entity').OrderOrmEntity): OrderResponseDto {
    ...
    return {
      ...
      return {
        ...
        targetCurrencyPurchasePrice: this.convertToTargetCurrency(item.purchasePrice, item.exchangeRateBuy),
        targetCurrencyPurchaseTotal: this.convertToTargetCurrency(item.purchaseTotal, item.exchangeRateBuy),
        targetCurrencyShippingPrice: item.shippingPrice ? this.convertToTargetCurrency(item.shippingPrice, item.exchangeRateBuy) : null,
        targetCurrencyTotalCostBeforeDiscount: this.convertToTargetCurrency(item.totalCostBeforeDiscount, item.exchangeRateBuy),
        targetCurrencyDiscountType: item.discountType,
        targetCurrencyDiscountValue: item.discountValue ? this.convertToTargetCurrency(item.discountValue, item.exchangeRateBuy) : null,
        targetCurrencyDiscountAmount: this.convertToTargetCurrency(item.discountAmount, item.exchangeRateBuy),
        targetCurrencyFinalCost: this.convertToTargetCurrency(item.finalCost, item.exchangeRateBuy),
