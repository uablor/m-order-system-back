  ...
  private toResponse(entity: import('../entities/customer-order.orm-entity').CustomerOrderOrmEntity): CustomerOrderResponseDto {
    return {
      ...
      customerOrderItems: entity.customerOrderItems?.map(item => ({
        ...
        exchangeRateBuy: item.orderItem?.exchangeRateBuy || null,
        exchangeRateSell: item.orderItem?.exchangeRateSell || null,
        exchangeRateBuyValue: item.orderItem?.exchangeRateBuy?.rate || null,
        exchangeRateSellValue: item.orderItem?.exchangeRateSell?.rate || null,
