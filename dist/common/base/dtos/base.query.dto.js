...
const base_query_enum_1 = require("../enums/base.query.enum");
class BaseQueryDto {
    page = 1;
    limit = 10;
    search;
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ default: 10, minimum: 1, maximum: 1000 }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(1),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Search term to filter results' }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        enum: base_query_enum_1.SortDirection,
