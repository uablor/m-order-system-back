...
const response_helper_2 = require("../../../common/base/helpers/response.helper");
let OrderQueryService = class OrderQueryService {
    orderRepository;
    orderQueryRepository;
    constructor(orderRepository, orderQueryRepository) {
    ...
    async getList(query) {
        ...
        return {
            success: true,
            Code: response_helper_2.DEFAULT_SUCCESS_CODE,
            message: response_helper_2.DEFAULT_SUCCESS_MESSAGE,
    ...
    toResponse(entity) {
        ...
        return {
            ...
            shippingExchangeRate: entity.shippingExchangeRate ? {
                id: entity.shippingExchangeRate.id,
                baseCurrency: entity.shippingExchangeRate.baseCurrency,
                targetCurrency: entity.shippingExchangeRate.targetCurrency,
                rate: entity.shippingExchangeRate.rate.toString(),
                rateType: entity.shippingExchangeRate.rateType,
                rateDate: entity.shippingExchangeRate.rateDate,
                isActive: entity.shippingExchangeRate.isActive,
            } : null,
            ...
            totalShippingCost: entity.totalShipping.toString(),
            ...
            targetCurrencyTotalShippingCost: this.convertToTargetCurrency(entity.totalShipping, entity.exchangeRateBuy),
            ...
            targetCurrencyTotalShippingCostByShippingExchangeRate: this.convertToTargetCurrency(entity.totalShipping, entity.shippingExchangeRate),
            orderItems: (entity.orderItems ?? []).map((item) => {
                return {
                    ...
                    shippingExchangeRate: item.order?.shippingExchangeRate ? {
                        id: item.order.shippingExchangeRate.id,
                        baseCurrency: item.order.shippingExchangeRate.baseCurrency,
                        targetCurrency: item.order.shippingExchangeRate.targetCurrency,
                        rate: item.order.shippingExchangeRate.rate.toString(),
                        rateType: item.order.shippingExchangeRate.rateType,
                        rateDate: item.order.shippingExchangeRate.rateDate,
                        isActive: item.order.shippingExchangeRate.isActive,
                    } : null,
            ...
            customerOrders: (entity.customerOrders ?? []).map((customerOrder) => ({
                ...
                discountType: customerOrder.discountType,
                discountValue: customerOrder.discountValue,
                discountAmount: customerOrder.discountAmount.toString(),
