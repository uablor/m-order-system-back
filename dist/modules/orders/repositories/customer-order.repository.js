...
let CustomerOrderRepository = class CustomerOrderRepository extends base_repository_1.BaseRepository {
    constructor(repository) {
        super(repository);
    }
};
exports.CustomerOrderRepository = CustomerOrderRepository;
exports.CustomerOrderRepository = CustomerOrderRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(customer_order_orm_entity_1.CustomerOrderOrmEntity)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], CustomerOrderRepository);
//# sourceMappingURL=customer-order.repository.js.map