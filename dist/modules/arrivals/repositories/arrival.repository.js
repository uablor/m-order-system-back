...
let ArrivalRepository = class ArrivalRepository extends base_repository_1.BaseRepository {
    constructor(repository) {
        super(repository);
    }
};
exports.ArrivalRepository = ArrivalRepository;
exports.ArrivalRepository = ArrivalRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(arrival_orm_entity_1.ArrivalOrmEntity)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], ArrivalRepository);
//# sourceMappingURL=arrival.repository.js.map