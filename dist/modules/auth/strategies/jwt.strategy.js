...
const user_query_service_1 = require("../../users/services/user-query.service");
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, 'jwt') {
    configService;
    userQueryService;
    constructor(configService, userQueryService) {
        super({
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromAuthHeaderAsBearerToken(),
            ignoreExpiration: false,
            secretOrKey: configService.get('app.jwt.secret', { infer: true }) ?? 'change-me-in-production',
        });
